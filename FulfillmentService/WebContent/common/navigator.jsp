...
<div class="col-sm-3 col-md-2 sidebar">
	...
	<c:if test="${id.equals('admin')}">
		<li><a href="/FulfillmentService/CalculateCostProc?action=list&page=1">월단위 판매내역<br>(쇼핑몰)</a></li>
		<!-- <li><a href="/FulfillmentService/CalculateCostProc?action=calculateShop">월단위 판매내역<br>(쇼핑몰)</a></li> -->
        <li><a href="/FulfillmentService/CalculateCostProc?action=calculateOrder">월단위 발주내역<br>(구매처)</a></li>
