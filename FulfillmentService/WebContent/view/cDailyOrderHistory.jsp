	...
	<div class="row">
		...
		<div class="col-sm-9 col-md-10  main">
			<div class="col-md-7">
		 	...
		 	<div class="col-md-5">
				<form action="/FulfillmentService/CalculateCostProc?action=cSelectDate" class="form-horizontal" method="post" name="form">
					<label for="selectMonth">
					Date : 
					</label>&nbsp;
					<input name="selectDate" id="selectDate" class="date-picker" autocomplete="off" />&nbsp;
